...
const OAuthButton = ({ provider, onClick, children }) => (
  <button
    type="button"
    className="w-full flex items-center justify-center gap-2 border border-gray-300 py-2 rounded hover:bg-gray-100 transition-colors"
    onClick={onClick}
  >
    {provider === 'google' && (
      <svg className="w-5 h-5 align-middle" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2">
